...
#' decomposition.  The type of plot shown depends on the value of \code{type}.
#' \itemize{ \itemcomponentsShows the final estimated components with
#' breakpoints. \itemallPlots the estimated components and breakpoints from all
#' iterations. \itemdataJust plots the original time series data.
#' \itemseasonalShows the trend component including breakpoints.
#' \itemtrendShows the trend component including breakpoints. \itemnoisePlots
#' the noise component along with its acf and pacf. } If \code{sim} is not
#' \code{NULL}, the components used in simulation are also shown on each graph.
#' 
