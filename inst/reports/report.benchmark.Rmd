...
for (i in 1:length(fs))
{
  ...
  set_fast_options() # TODO: devide by n?
...
par(oma=c(5,0,0,0))
par(cex=0.8)
barplot(horiz=F,height = t(as.matrix(r[,c("time.default","time.fast")])), beside = T, names.arg = r$f, ylab="Computation time (seconds)", legend.text=c("set_default_options()", "set_fast_options()"), las=3, args.legend=list(x="topleft"))
```
